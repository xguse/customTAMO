...
def main(fastafile):  # !! 1/2/09 AD added 'fastafile' var and changed 'if __name__' as way to call this from script.
    ...
    for w in range(1,7):
        ...
        _t = nmersD.keys()
        _t.sort()
        print "# freq in %s (total %d with pseudocounts)"%(fastafile,total)
        for nmer in _t:
